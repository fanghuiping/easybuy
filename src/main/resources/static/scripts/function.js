...
$(function(){
    ...
    $("#changeCode").click(function(){
        $("#safeCode").attr("src","Number.html?id="+Math.random());
    });
    //注册页面验证
...
//            location.href = "Cart?action=addAddress&address="+$("#addAddr").val();
    ...
    $("#shoppingBag").mouseover(function(){
        ...
        var html=[
            ...
            "<tr th:each=\"p : ${session.product}\">" +
            "<td><img width=\"20\" height=\"20\" th:src=\"@{../static/images/product/{fileName}(fileName=${p.fileName})}\"/></td>" +
            "<td th:text=\"${p.name}\">VVVVV</td>" +
            "<td>￥[[${p.price}]]</td></tr>"
        ]
        /*]]>*/
